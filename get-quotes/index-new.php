...
<style type="text/css">
	...
	@media only screen and (max-width: 767px) {
		...
		.help-block { bottom: 5px; font-size: 11px; font-weight: 700; left: 1px; position: absolute; }
		.page-title h4 { font-size: 14px; margin: 0; }
		.page-title { background: #efefef !important; font-size: 14px !important; margin-bottom: 23px !important; padding: 20px 0 !important;	}
		.row { margin-bottom: 24px !important; }
		.last-field { clear: both; display: block; margin: 0; padding: 0; padding-right: 0; padding-top: 20px; }
  }
...
<div class="jumbotron <?php echo 'state-' . strtolower($_GET['state']); ?> blue-gradient hidden-xs">
  <div class="container text-center">
    ...
    <div class="stepprogress step-2">
      <div class="stepprogress-bar"><span class="hidden-xs">Step 1 — </span>Enter Zip</div>
      <div class="stepprogress-bar"><span class="hidden-xs">Step 2 — </span>Quote</div>
      <div class="stepprogress-bar"><span class="hidden-xs">Step 3 — </span>Compare</div>
    </div>
  </div>
</div>
...
<div class="get-info container style-1">
  ...
  <div id="form">
	...
	<div class="display:flex; flex-direction: column; align-items:center; text-align:center">
		<p style="display:flex; width: 80%; color: #728c98;">
			<small>
		...
		<p style="display:flex; width: 70%; color: #728c98;">
...
<script>
    ...
    var redirectUrlUpdate = function() {
      ...
      if( age >= 65 ) {
        ...
        redirectUrl.val('/get-quotes/plans.php?type=medicare&city=' + city + '&state=' + state + '&Household=1&Age=' + (age > 18 ? age : '18') + '&src=' + src );

      } else {

        redirectUrl.val('/get-quotes/plans.php?type=healthcare&city=' + city + '&state=' + state + '&Household=1&Age=' + (age > 18 ? age : '18') + '&src=' + src );
    ...
    function getAge() {
      ...
      var BM = $('[name="birthmonth"]').val();
      var BD = $('[name="birthday"]').val();
    ...
    function setSRC() {
      ...
      //Check for Alpha In Landing Page for Kobe SRC
    ...
    // Submit Form
        ...
        // Set Redirect URL based on Field Data
        redirectUrlUpdate();
